        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button variant='dark' route='/services'>View Services</Button>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            variants={itemVariants}
            style={{
              WebkitMaskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent), linear-gradient(to bottom, black 60%, transparent)',
              maskImage: 'linear-gradient(to right, transparent, black 10%, black 90%, transparent), linear-gradient(to bottom, black 60%, transparent)',
            }}
          >
              <Marquee
                direction="right"
