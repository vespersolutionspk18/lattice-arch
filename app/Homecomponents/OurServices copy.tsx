        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full gap-4 md:gap-6 lg:gap-4">
          {services.slice(0, 3).map((service, index) => {
            ...
            return (
              <motion.div
                key={service.title}
                className="relative flex flex-col gap-4 md:gap-6 lg:gap-7 p-4 md:p-6 lg:p-7 rounded-2xl md:rounded-3xl lg:rounded-4xl bg-[radial-gradient(ellipse_at_50%_150%,_#4c1d95_0%,_#000000_70%)] border-[1px] border-purple-950/50 w-full overflow-hidden group"
                custom={index}
              ...
              >
                ...
                <motion.div 
                  className="flex flex-col items-center justify-center  rounded-full p-3 w-fit"
                ...
                <motion.h5 
                  className="text-xl md:text-2xl lg:text-3xl text-white/90 font-semibold tracking-tighter"
                >
                  {service.title}
                </motion.h5>
                <motion.p 
                  className="text-sm md:text-base lg:text-xl text-white/80"
                >
                  {service.description}
                </motion.p>
                <motion.div
